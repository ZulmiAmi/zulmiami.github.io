...
var style_NakesPerawat_10 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Perawat");
    var labelText = "";
    size = 0;
    ...
    if (value > 9.000000 && value <= 15.500000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 15.500000 && value <= 22.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 22.000000 && value <= 28.500000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 28.500000 && value <= 35.000000) {
            style = [ new ol.style.Style({
