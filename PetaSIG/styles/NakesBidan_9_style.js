...
var style_NakesBidan_9 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Bidan");
    var labelText = "";
    size = 0;
    ...
    if (value > 8.000000 && value <= 15.750000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 15.750000 && value <= 23.500000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 23.500000 && value <= 31.250000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 31.250000 && value <= 39.000000) {
            style = [ new ol.style.Style({
